describe('ApproveReports', function () {
    ...
    describe('ApproveReportsController', function () {
        ...
        beforeEach(function () {
            ...
            controller = $controller('PendingReportsController', { $scope: $scope, $modalInstance: modalInstance, itemId: 2, Report: reportMock, OrgUnit: orgUnitMock, Person: personMock });
