angular.module("application").controller("EditAddressController", [
    "$scope", "$modalInstance", "itemId", "NotificationService", "StandardAddress", "SmartAdresseSource", function ($scope, $modalInstance, itemId, NotificationService, StandardAddress, SmartAdresseSource) {
