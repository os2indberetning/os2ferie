angular.module("application").controller("MyPendingReportsController", [
   "$scope", "$modal", "$rootScope", "Report", "$timeout", "Person", "RateType","MkColumnFormatter", function ($scope, $modal, $rootScope, Report, $timeout, Person, RateType,MkColumnFormatter) {
                   ...
                   template: function (data) {
                       ...
                       if (data.KilometerAllowance != "Read") {
                           ...
                           if (data.IsFromApp) {
                               ...
                               return "<div class='inline margin-left-5' kendo-tooltip k-content=\"'" + comment + "'\">Aflæst manuelt</div>";
                           }
                       }
                   }
               }, {
