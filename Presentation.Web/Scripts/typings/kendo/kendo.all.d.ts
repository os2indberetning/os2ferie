...
declare module kendo {    
    ...
    function wrap(element: JQuery): JQuery;
    function eventTarget(e): any;
    function stringify(value: any): string;
    function deepExtend(destination: Object, ...sources: Object[]): Object;
    ...
    function culture(): any; //does not return a string but a culture object!
...
declare module kendo.data {
    ...
    class Query {
        constructor(data: any[]);
        sort(field: string, dir: string, comparer?: any): Query;
...
declare module kendo.ui {
    function plugin(widget, register?, prefix?);
...
declare module kendo.ui {
    ...
    class ComboBox extends kendo.ui.Widget {
        ...
        _template(): void;
        _adjustListWidth(): boolean;
        _filterSource(filter): void;
    ...
    class Menu extends kendo.ui.Widget {
        ...
        append(item: string, referenceItem: JQuery): kendo.ui.Menu;
    ...
    class Validator extends kendo.ui.Widget {
        ...
        _errors: Object;
        _findMessageContainer(fieldName: string): JQuery;
    }
...
declare module kendo.dataviz.ui {
    var themes: any[];
    function registerTheme(themeName: string, options: any): void;
...
interface JQuery {
    ...
    kendoStop(clearQueue?: boolean, gotoEnd?: boolean): JQuery;
    kendoAnimate(options, duration?, reverse?, complete?): JQuery;
    ...
    getKendoChart(): kendo.dataviz.ui.Chart;
